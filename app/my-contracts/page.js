  ...
  return (
    <div className={isDark ? 'theme-dark' : 'theme-light'} style={{minHeight:'100vh'}}>
      <style>{`
        ...
        .theme-dark {
          --bg: #000000; --surface: #111118; --border: #1e1e2e;
          background: #000000;   /* ← thêm dòng này */
        ...
        .theme-light {
          --bg: #f0f4ff; --surface: #ffffff; --border: #dde3f0;
            background: #f0f4ff;   /* ← thêm dòng này */
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        body { background: var(--bg); color: var(--text); font-family: sans-serif; min-height: 100vh; transition: background 0.25s, color 0.25s; }
        body::before {
        ...
        .logo {
          ...
          margin-right: 1rem; white-space: nowrap; cursor: pointer;
        }
        .nav-btn {
          background: transparent; border: none; padding: 0.4rem 0.85rem;
        ...
        .page { max-width: 860px; margin: 0 auto; padding: 2rem 1.5rem 5rem; padding-top: calc(var(--navbar-h) + 2.5rem); }
        ...
        .btn {
          ...
          padding: 0.65rem 1.1rem; border-radius: 8px; font-family: var(--font-mono);
        ...
        .btn-secondary:hover { background: rgba(6,182,212,0.1); transform: translateY(-1px); }
        ...
        .card-arrow {
          font-size: 1rem; color: var(--accent); opacity: 0; transition: opacity 0.15s;
        ...
        .open-tag {
          font-family: var(--font-mono); font-size: 0.62rem; color: #a78bfa;
          background: rgba(124,58,237,0.12); border: 1px solid rgba(124,58,237,0.25);
          padding: 0.2rem 0.55rem; border-radius: 4px; font-weight: 700;
        ...
        .back-btn {
          ...
          padding: 0; margin-bottom: 1.5rem; display: flex; align-items: center;
      ...
      <nav className="navbar">
        <div className="nav-left">
          <div className="logo" onClick={() => router.push('/')}>EscrowMAD</div>
          <button className="nav-btn active">My Contracts</button>
          <button className="nav-btn" onClick={() => router.push('/')}>+ New Contract</button>
          <button className="nav-btn" onClick={() => router.push('/')}>Join Contract</button>
        </div>
