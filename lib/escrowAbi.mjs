...
export const ESCROW_ABI = [
  ...
  { inputs: [], name: 'deliveryProofHash', outputs: [{ type: 'string' }], stateMutability: 'view', type: 'function' },
  { inputs: [{ name: 'ipfsHash', type: 'string' }], name: 'uploadDeliveryProof', outputs: [], stateMutability: 'nonpayable', type: 'function' },
